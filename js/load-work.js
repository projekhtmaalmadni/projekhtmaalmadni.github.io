document.addEventListener("DOMContentLoaded", async () => {
  const sections = [
    { id: "navbar", file: "sections/navbar-detail.html" },
    { id: "work-detail", file: "sections/work-detail.html" },
    { id: "footer", file: "sections/footer-detail.html" },
  ];
          ...
          <div style="
              ...
              ">
                <div style="
                  ...
                  text-align:center;
                ">
                  <img src="https://media1.tenor.com/m/BLie79l9FTYAAAAC/miyako-blue-archive.gif"
...
const projectCardObserver = new IntersectionObserver((entries) => {
  entries.forEach(entry => {
    if (entry.isIntersecting) {
      ...
      entry.target.classList.add("show"); // pastikan ada animasi .show di CSS
